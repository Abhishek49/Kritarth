...
**/
	...
	( function ( ) {
		var onFullLoad = function ( ) {
			...
			loaderHandler . hideLoader ( null , { complete : function ( ) { animationEffects . fadeInElement ( document . getElementById ( defaultPageID ) ) ; } } ) ;
	...
	( function ( ) {
		var pageSwitchHandler = {
			...
			goForwardToPage : function ( pageID , durationTime ) {
				animationEffects . fadeOutElement ( document . getElementById ( pageSwitchHandler . currentPageID ) , { complete : function ( ) {
	...
	( function ( ) {
		var pageAJAXLoaderHandler = {
			...
			goForwardToPage : function ( pageID , pageAJAXURL , durationTime ) {
				animationEffects . fadeOutElement ( document . getElementById ( pageAJAXLoaderHandler . currentPageID ) , { complete : function ( ) {
					variableListeners . setListeners ( false ) ;
					if ( window . innerHeight > window . innerWidth ) durationTime = durationTime || 100 ;
					else durationTime = durationTime || 100 ;
